...
<html lang="en">
    <head>
        ...
        <title>Our Privacy Policy - Privacy Policy Online</title>
                ...
                <div class="container">
                    <div class="row d-flex">
                        <div class="col">
                            ...
                            <p>At www.PrivacyPolicyOnline.com we consider the privacy of our visitors to be extremely important. This privacy policy document describes in detail the types of personal information is collected and recorded by www.PrivacyPolicyOnline.com and how we use it. </p>
                            <h4 class="font-weight-bold mt-5 mb-3">Log Files</h4>
                            <p>Like many other Web sites, www.PrivacyPolicyOnline.com makes use of log files. These files merely logs visitors to the site – usually a standard procedure for hosting companies and a part of hosting services's analytics. The information inside the log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date/time stamp, referring/exit pages, and possibly the number of clicks. This information is used to analyze trends, administer the site, track user's movement around the site, and gather demographic information. IP addresses, and other such information are not linked to any information that is personally identifiable. </p>
                            <h4 class="font-weight-bold mt-5 mb-3">Cookies and Web Beacons</h4>
                            <p>www.PrivacyPolicyOnline.com does not use cookies.</p>
                            <p><em>While each of these advertising partners has their own Privacy Policy for their site, an updated and hyperlinked resource is maintained here: <a
                            href="https://www.privacypolicyonline.com/privacy-policy-links/">Privacy Policy Links</a>.<br> <br> You may consult this listing to find the privacy policy for each of the advertising partners of www.PrivacyPolicyOnline.com.</em></p>
                            ...
                            <p>www.PrivacyPolicyOnline.com has no access to or control over these cookies that are used by third-party advertisers. </p>
                            <h4 class="font-weight-bold mt-5 mb-3">Third Party Privacy Policies</h4>
                            ...
                            <p> If you wish to disable cookies, you may do so through your individual browser options. More detailed information about cookie management with specific web browsers can be found at the browsers' respective websites. <a href="https://www.privacypolicyonline.com/what-are-cookies/">What
                            Are Cookies?</a></p>
                            <h4 class="font-weight-bold mt-5 mb-3">Children's Information</h4>
